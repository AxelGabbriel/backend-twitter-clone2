...
exports.uploadImage = async (req, res) => {
    ...
    try {
        ...
        /*const resultdb = await pool.query('INSERT INTO foto(url,manga,autor,capitulo,image_id,pagina) VALUES($1,$2,$3,$4,$5,$6)', [
            ...
            const resultdb= await pool.query('INSERT INTO post(id_usuario,contenido,foto_url,fecha,id_foto) VALUES($1,$2,$3,$4,$5)', [
                id_usuario,contenido,result.url,fecha,result.public_id])
