...
const like = async (req, res) => {
  ...
  const result = await pool.query('INSERT INTO liked(id_user,id_post) VALUES($1,$2) WHERE NOT EXISTS (SELECT id_user, id_post FROM liked WHERE id_user=$1 and id_post=$2)', [
    id_user, id_post])
  console.log(result)
